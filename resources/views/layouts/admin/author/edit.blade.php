        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.authors.update',$author->id)}}" method="post"
                    enctype="multipart/form-data" class="author">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <input class="form-control" name="name" type="text"
                                    value="{{old('name')?? $author->name}}" id="example-text-input">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="description" type="text"
                                    value="{{old('description')?? $author->description}}" id="example-text-input">
                                <div class="mt-2">
                        ...
                        <div class="col-sm-12 mb-2">
                            <img class="rounded mr-2 mo-mb-2" alt="200x200" style="width: 200px;"
                                src="{{asset('storage/images/'.$author->image)}}" data-holder-rendered="true">
                        </div>
