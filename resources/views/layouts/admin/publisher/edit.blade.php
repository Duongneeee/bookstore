        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.publishers.update',$publisher->id)}}" method="post"
                    enctype="multipart/form-data" class="publisher">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group ">
                                ...
                                <input class="form-control" name="name" type="text"
                                    value="{{old('name')?? $publisher->name}}" id="example-text-input">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="description" type="text"
                                    value="{{old('description')?? $publisher->description}}" id="example-text-input">
                                <div class="mt-2">
    ...
    $(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if (response.success) {
                        window.location.href = '{{route('admin.publishers.index')}}';
                    }
                },
