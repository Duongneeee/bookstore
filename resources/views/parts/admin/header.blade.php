    ...
    <nav class="navbar-custom">
        <ul class="list-inline float-right mb-0">
            ...
            <li class="list-inline-item dropdown notification-list hide-phone"><a
                    ...
                    aria-expanded="false">English <img src="{{asset('backend/images/flags/us_flag.jpg')}}"
                        class="ml-2" height="16" alt=""></a>
                <div class="dropdown-menu dropdown-menu-right language-switch"><a class="dropdown-item"
                        href="#"><img src="{{asset('backend/images/flags/italy_flag.jpg')}}" alt=""
                            height="16"><span>Italian </span></a><a class="dropdown-item" href="#"><img
                            src="{{asset('backend/images/flags/french_flag.jpg')}}" alt="" height="16"><span>French
                        </span></a><a class="dropdown-item" href="#"><img
                            src="{{asset('backend/images/flags/spain_flag.jpg')}}" alt="" height="16"><span>Spanish
                        </span></a><a class="dropdown-item" href="#"><img
            ...
            <li class="list-inline-item dropdown notification-list"><a
                    ...
                    data-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                    aria-expanded="false"><img src="{{asset('backend/images/users/avatar-6.jpg')}}" alt="user"
